...
import { getCartProductById } from 'apiSdk/cart-products';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Cart Product Detail View
          </Text>
          {hasAccess('cart_product', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/cart-products/edit/${data?.id}`} passHref legacyBehavior>
              <Button
